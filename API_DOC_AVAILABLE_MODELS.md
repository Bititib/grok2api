...
| **`sd2.5`** | `720p` | `16:9` / `9:16` / `1:1` / `21:9` / `3:4` / `4:3` | `30` 秒 | ✅ 图(50) (不支持视频和音频) | **5.00 元 / 次** | Seedance 2.5 全能多模态视频生成（支持50图，不支持视频和音频，固定30秒） |
| **`sd-c6`** | `720p` | `16:9` / `9:16` / `1:1` / `21:9` / `3:4` / `4:3` | `10` 秒 | ✅ 图(9) / 视(3) / 音(3) | **1.50 元 / 次** | Seedance 多模态视频生成（支持9图3视3音） |
| **`sora-v3-933-pro`** | `720p` | `16:9` / `9:16` / `4:3` / `3:4` / `1:1` / `21:9` | `5`–`15` 秒 | ✅ 图(9) / 视(3) / 音(3) | **5.00 元 / 次** | 933 真人视频生成（支持图片/视频/音频多模态参考） |
| **`tejiasd2`** | `720p` | `16:9` / `9:16` / `4:3` / `3:4` / `1:1` / `21:9` | `5`–`15` 秒 | ✅ 图(9) / 视(3) / 音(3) | **3.00 元 / 次** | 特价真人视频生成（同 sora-v3-933-pro 渠道） |
| **`sdas-xh-minimax-h3-2k`** | `2k` | `1:1` / `3:4` / `4:3` / `9:16` / `16:9` / `21:9` | `15` 秒 | ✅ 图(9) / 视(3) / 音(3) / 真人面部 | **3.00 元 / 次** | 海螺h3 高清视频生成（支持9图3视3音/固定15s） |
| **`ld-sdas-cvk-pro-933-720p`** | `720p` | `21:9` / `16:9` / `4:3` / `1:1` / `3:4` / `9:16` | `4`–`15` 秒 | ✅ 图(9) / 视(3) / 音(3) / 真人面部 | **4.00 元 / 次** | Seedance 2.0 720p 满血视频生成（速大水渠道/支持真人） |
| **`sd2.0-480p`** | `480p` | `16:9` / `9:16` / `1:1` / `4:3` / `3:4` / `21:9` | `4`–`15` 秒 | ✅ 图(9) / 视(3) / 音(3) / 真人面部 | **0.35 元 / 秒** | Seedance 2.0 480p 满血版（按秒计费） |
| **`sd2.0-fast-480p`** | `480p` | `16:9` / `9:16` / `1:1` / `4:3` / `3:4` / `21:9` | `4`–`15` 秒 | ✅ 图(9) / 视(3) / 音(3) / 真人面部 | **0.25 元 / 秒** | Seedance 2.0 480p 快速版（按秒计费） |
