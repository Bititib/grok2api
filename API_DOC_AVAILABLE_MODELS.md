...
| **`sd2.5`** | `720p` | `16:9` / `9:16` / `1:1` / `21:9` / `3:4` / `4:3` | `4`–`15` 秒 | ✅ 图(50) / 视(10) / 音(10) | **2.00 元 / 次** | Seedance 2.5 全能多模态视频生成（支持50图10视10音） |
...
| **`ld-sdas-h3-501-2k`** | `2k` | `1:1` / `3:4` / `4:3` / `9:16` / `16:9` | `5`–`15` 秒 | ✅ 图(5) / 视(0) / 音(1) / 真人面部 | **3.50 元 / 次** | 海螺h3 高清视频生成（支持真人/按次计费） |
| **`ld-sdas-cvk-pro-933-720p`** | `720p` | `21:9` / `16:9` / `4:3` / `1:1` / `3:4` / `9:16` | `4`–`15` 秒 | ✅ 图(9) / 视(3) / 音(3) / 真人面部 | **4.70 元 / 次** | Seedance 2.0 720p 满血视频生成（速大水渠道/支持真人） |
