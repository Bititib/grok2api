...
| 模型名 | 版本 | 说明 | 推荐 |
|--------|------|------|------|
| `grok-imagine-video` | 1.0 版本 | 标准视频生成（基于 1.0） | ⭐ 推荐 |
| `grok-imagine-video-1.5-preview` | 1.5 版本 | Grok 1.5 视频预览版，画面连贯度与清晰度极大提升 | ⭐⭐ 推荐 |
| `grok-imagine-video-1.5-fast` | 1.5 版本 | Grok 1.5 视频快速版，在画质与速度中取得极佳平衡 | |
| `grok-imagine-1.0-video` | 1.0 版本 | 标准视频生成（可显式调用 1.0） | |
