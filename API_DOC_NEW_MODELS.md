...
| **`ld-sdas-cvk-pro-933-720p`** | **`720p` 高清** | **按次计费** | **3.70 元 / 次** | `4`–`15` 秒 | 图(9) / 视(3) / 音(3)<br>✅ 支持真人面部 | Seedance 2.0 720p 满血版（速大水渠道），画质清晰，支持多模态参考与真人人脸保持。 |
| **`sd2.0-480p`** | **`480p` 标准** | **按秒计费** | **0.35 元 / 秒** | `4`–`15` 秒 | 图(9) / 视(3) / 音(3)<br>✅ 支持真人面部 | Seedance 2.0 480p 满血版，概率卡脸，非常适合漫剧、线图及真人分身。 |
| **`sd2.0-fast-480p`** | **`480p` 标准** | **按秒计费** | **0.25 元 / 秒** | `4`–`15` 秒 | 图(9) / 视(3) / 音(3)<br>✅ 支持真人面部 | Seedance 2.0 480p 快速版，渲染速度极快，高性价比视频制作首选。 |
