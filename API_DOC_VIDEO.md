...
resp = requests.post("https://api.yourdomain.com/v1/videos",
...
```bash
curl https://api.yourdomain.com/v1/videos/video_61be39094ee24240b27a09c673beb068 \
  -H "Authorization: Bearer sk-你的Key"
```
...
```json
{
  ...
  "url": "https://api.yourdomain.com/v1/files/video?id=video_61be39094ee24240b27a09c673beb068",
  "model": "grok-imagine-video",
  "prompt": "...",
  "seconds": "6",
  "size": "1280x720",
...
```bash
# 浏览器直接打开
https://api.yourdomain.com/v1/files/video?id=video_61be39094ee24240b27a09c673beb068

# curl 下载
curl -o output.mp4 "https://api.yourdomain.com/v1/files/video?id=video_61be39094ee24240b27a09c673beb068"
```
...
| 错误信息 | 原因 | 解决 |
|----------|------|------|
| `Model 'xxx' is not a video model` | 模型名拼写错误 | 使用 `grok-imagine-video` 或其他受支持的模型 |
